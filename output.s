...
__div_zero_msg: .asciiz "Runtime error: division by zero at line "
__div_zero_line_slot: .word 0
...
__bounds_ok_19:
    ...
    li $t1, 5
    li $t2, 163
    sw $t2, __div_zero_line_slot
    beq $t1, $zero, __div_zero_error
    div $t0, $t1
    mflo $t0
    sw $t0, 444($sp)
    lw $t0, 444($sp)
...
__div_zero_error:
    li $v0, 4
    la $a0, __div_zero_msg
    syscall
    lw $a0, __div_zero_line_slot
    li $v0, 1
    syscall
    li $v0, 11
    li $a0, 10
